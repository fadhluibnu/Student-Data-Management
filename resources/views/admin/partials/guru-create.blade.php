...
<div class="mb-3">
    ...
    <button class="btn btn-outline-secondary my-costume-table dropdown-toggle show-button" type="button" id="walikelas"
        data-bs-toggle="dropdown" aria-expanded="false">
        Pilih kelas
    </button>
    <input type="hidden" id="walasSelect" name="walikelas_id">
...
<div class="mb-3">
    ...
    <input type="hidden" class="form-control" id="sekolah_hide" placeholder="name@example.com" name="sekolah_id"
        value="{{ auth()->user()->sekolah_id }}" required>
